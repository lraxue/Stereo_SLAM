...
namespace Stereo_SLAM {
    ...
    public:
        ...
        std::map<Frame*, size_t > GetFoundersOfFrame();
        ...
        void IncreaseFoundByFrame(const int& n = 2);
    ...
    public:
        ...
        // Point type to record the point is temporal point or global point
        mPointType mType;
