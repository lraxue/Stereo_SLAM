...
namespace Stereo_SLAM {
    ...
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
        ...
        // mptLocalMapping = new thread(&ORB_SLAM2::LocalMapping::ProcessKeyFrame, mpLocalMapper);
    ...
    cv::Mat System::TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp) {
        ...
        LOG(INFO) << "GrabImageStereo finished.";
    ...
    void System::Shutdown() {
        ...
        if (mpViewer)
            pangolin::BindToContext("Stereo-SLAM: Map Viewer");
    }
    ...
    void System::SaveTrajectoryTUM(const string &filename) {
        ...
        list<Stereo_SLAM::KeyFrame *>::iterator lRit = mpTracker->mlpReferences.begin();
